...
const ViewDocumentHod = ({ isShowUpload, getDataFromChild, lessonPlan, loadingStatus, appendix, userLoginValue, subjectSelect, deleteItemList }) => {
        ...
        try {
            if (data === 2) {
                ...
                if (selectedScorm.fileExtension === '.docx') {
                    fetDataDocUrl(selectedScorm.id, appendix, selectedScorm.name)
                } else {
                    fetDataDocUrl(selectedScorm.id, appendix, selectedScorm.name)
                }
            }
        ...
        <div>
            ...
            <div id="view-document-wrapper">
                <div ref={hidePopupRef} className="borderPopUp">
                    ...
                    {isLoading && (
                        <>
                            <div style={{ backgroundColor: 'white', margin: '0', padding: '0', height: '100%' }} className="loading">
                                <div
                                    style={{ left: '48%' }}
                                    className="loader"
                            ...
                            <div style={{ display: 'flex', width: '100%', justifyContent: 'center', alignItems: 'center', fontFamily: 'GoogleSans-Medium', fontSize: '18px' }}>
                                <p>{msgLoad}</p>
                            </div>
                        </>
                    )}
...
export default ViewDocumentHod;
