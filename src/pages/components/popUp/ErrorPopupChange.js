...
const ErrorPopupChange = ({ getDataFromChild, errorMsg }) => {
        ...
        <>
            <div id="error-wrapper">
                <div ref={errorRef} className="errorSelect">
                    ...
                    <div style={{justifyContent: 'space-around'}} className="btnClose">
                        <button style={{width: '45%'}} onClick={() => handleSaveBtn()}>Lưu</button>
                        <button style={{width: '45%', backgroundColor: '#4B4F56'}} onClick={() => handleCloseBtn()}>Huỷ</button>
                    </div>
                </div>
            </div>
        </>
...
export default ErrorPopupChange