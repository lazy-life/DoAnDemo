...
//chỉ tiết này => id: 0
const AddSession = ({ dataTeacher, getDataFromChild, dataModifySession, handleClose }) => {
    ...
    const handleSave = () => {
        if (!selectSubject || Object.values(selectSubject)[0] === 0) {
            ...
            const data = {
                ...
                "repeat": (parseInt(Object.values(repeat)[0]) - 1).toString()
            }
            ...
            <div id="modifySession-wrapper">
                <div ref={popupRef} className="popup">
                    ...
                    <div className="bottomPopup">
                        ...
                        <button onClick={() => handleSave()} className="save">Thêm</button>
                    </div>
                </div>
            </div>
